...
export default function PastReactWork() {
  return (
    <div className='body__container aem-work'>
      <div className='heading'><h1>React Projects </h1><div className='alignleft para'>I was part this dev team I activly involved in development/maintainance/re-skining components listed below</div></div>
      {/* Start card 1 */}
      <div className='projects project_1'>
        <div className='column1 project_name'><h2>Beat Club</h2><div><a href='www.spectrum.com' target='blank'>www.beatclub.com</a></div></div>
        <div className='column2 Project_details pgrid-container'>
          <h2 className='titleV1 pgriditem1'>Home Page Redesining and Mudule Maintainance</h2>
      ...
      <div className='customHeading'><h2 className='container '>React Component developed</h2></div>
      <MovieComp></MovieComp>
    </div>
  )
}
